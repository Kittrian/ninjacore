...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-tertiary"
    },
    {
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-gray"
    },
    {
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-sky"
    },
    {
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-zinc"
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-inset has-focus-visible:ring-red"
    },
    {
    ...
    },
    {
      "color": "zinc" as typeof color[number],
      "highlight": true,
      "class": "ring ring-inset ring-zinc"
    },
    {
      "color": "red" as typeof color[number],
      "highlight": true,
