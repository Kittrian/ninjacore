...
export default {
  ...
  "variants": {
    ...
    "color": {
      ...
      "gray": {
        "trigger": "group-data-[state=completed]:bg-gray group-data-[state=active]:bg-gray focus-visible:outline-gray",
      ...
      "zinc": {
        "trigger": "group-data-[state=completed]:bg-zinc group-data-[state=active]:bg-zinc focus-visible:outline-zinc",
        "separator": "group-data-[state=completed]:bg-zinc"
      },
      "red": {
        "trigger": "group-data-[state=completed]:bg-red group-data-[state=active]:bg-red focus-visible:outline-red",
