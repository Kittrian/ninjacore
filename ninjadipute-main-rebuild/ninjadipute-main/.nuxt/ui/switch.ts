...
export default {
  ...
  "variants": {
    "color": {
      ...
      "gray": {
        "base": "data-[state=checked]:bg-gray focus-visible:outline-gray",
        "icon": "group-data-[state=checked]:text-gray"
      },
      "amber": {
      ...
      "zinc": {
        "base": "data-[state=checked]:bg-zinc focus-visible:outline-zinc",
        "icon": "group-data-[state=checked]:text-zinc"
      },
      "red": {
        "base": "data-[state=checked]:bg-red focus-visible:outline-red",
        "icon": "group-data-[state=checked]:text-red"
      },
      "purple": {
