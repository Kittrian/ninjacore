...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-gray data-highlighted:text-gray data-highlighted:before:bg-gray/10 data-[state=open]:before:bg-gray/10",
        "itemLeadingIcon": "text-gray/75 group-data-highlighted:text-gray group-data-[state=open]:text-gray"
      }
    },
    {
    ...
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-zinc data-highlighted:text-zinc data-highlighted:before:bg-zinc/10 data-[state=open]:before:bg-zinc/10",
        "itemLeadingIcon": "text-zinc/75 group-data-highlighted:text-zinc group-data-[state=open]:text-zinc"
      }
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-red data-highlighted:text-red data-highlighted:before:bg-red/10 data-[state=open]:before:bg-red/10",
        "itemLeadingIcon": "text-red/75 group-data-highlighted:text-red group-data-[state=open]:text-red"
      }
    },
    {
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "item": "text-gray before:bg-gray/10",
        "itemLeadingIcon": "text-gray"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "item": "text-zinc before:bg-zinc/10",
        "itemLeadingIcon": "text-zinc"
      }
    },
    {
      "color": "red" as typeof color[number],
      "active": true,
      "class": {
        "item": "text-red before:bg-red/10",
        "itemLeadingIcon": "text-red"
      }
    },
    {
      "color": "purple" as typeof color[number],
