...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-gray ring ring-inset ring-gray/25"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-zinc ring ring-inset ring-zinc/25"
      }
    },
    {
      "color": "red" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-red ring ring-inset ring-red/25"
      }
    },
    {
      "color": "purple" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-gray/10 text-gray ring ring-inset ring-gray/25"
      }
    },
    {
      "color": "amber" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-zinc/10 text-zinc ring ring-inset ring-zinc/25"
      }
    },
    {
      "color": "red" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-red/10 text-red ring ring-inset ring-red/25"
      }
    },
    {
      "color": "purple" as typeof color[number],
