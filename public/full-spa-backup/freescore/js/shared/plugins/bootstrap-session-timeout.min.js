...
(function($) {
    ...
    $.sessionTimeout = function(options) {
              ...
              <div class="modal-dialog modal-dialog-centered"> \
                <div class="modal-content"> \
                  <div class="modal-header"> \
                    <h4 class="modal-title fw-bold">' + opt.modalTitle + '</h4> \
                  </div> \
                  ...
                  <div class="modal-footer"> \
                    <button id="session-timeout-dialog-keepalive" type="button" class="btn btn-primary btn-sm" data-bs-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
        ...
        function registerModal() {
            modal = new bootstrap.Modal(document.getElementById('session-timeout-dialog'), {
        	  keyboard: false
        	})
        }
